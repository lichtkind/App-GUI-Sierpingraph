...
use App::GUI::Sierpingraph::Compute::Image;
...
sub connect_constrains_tab {
    my ($self, $ref) = @_;
    return unless ref $ref eq 'App::GUI::Siepingraph::Frame::Tab::Constraints';
...
sub paint {
    ...
    my $img = App::GUI::Sierpingraph::Compute::Image::from_settings(
