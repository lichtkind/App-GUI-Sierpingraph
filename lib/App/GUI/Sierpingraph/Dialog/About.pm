...
package App::GUI::Sierpingraph::Dialog::About;
...
sub new {
    ...
    my $version = Wx::StaticText->new( $self, -1, $App::GUI::Sierpingraph::NAME . '    version '.$App::GUI::Sierpingraph::VERSION , @label_property);
    ...
    my $url     = Wx::HyperlinkCtrl->new( $self, -1, 'metacpan.org/pod/App::GUI::Sierpingraph', 'https://metacpan.org/pod/App::GUI::Sierpingraph' );
