...
package App::GUI::Sierpingraph::Dialog::Interface;
...
sub new {
    ...
    my $settings13 = Wx::StaticText->new( $self,-1, 'A one time or alternating gradient between both colors with different Sierpinmics can be employed too.');
