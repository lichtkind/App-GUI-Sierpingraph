...
package App::GUI::Sierpingraph::Frame::Panel::ColorSetPicker;
...
sub new {
    ...
    $self->{'display'}[$_] = App::GUI::Sierpingraph::Widget::ColorDisplay->new( $self, 16, 9, $_, $default_color ) for 0 .. $self->{'max_display_count'}-1;
