...
package App::GUI::Sierpingraph::Frame::Part::ColorBrowser;
use base qw/Wx::Panel/;
use App::GUI::Sierpingraph::SliderCombo;
use App::GUI::Sierpingraph::ColorDisplay;
...
sub new {
    ...
    $self->{'red'}   =  App::GUI::Sierpingraph::SliderCombo->new( $self, 100, ' R  ', "red part of $type color",    0, 255,  0);
    $self->{'green'} =  App::GUI::Sierpingraph::SliderCombo->new( $self, 100, ' G  ', "green part of $type color",  0, 255,  0);
    $self->{'blue'}  =  App::GUI::Sierpingraph::SliderCombo->new( $self, 100, ' B  ', "blue part of $type color",   0, 255,  0);
    $self->{'hue'}   =  App::GUI::Sierpingraph::SliderCombo->new( $self, 100, ' H  ', "hue of $type color",         0, 359,  0);
    $self->{'sat'}   =  App::GUI::Sierpingraph::SliderCombo->new( $self, 100, ' S  ', "saturation of $type color",  0, 100,  0);
    $self->{'light'} =  App::GUI::Sierpingraph::SliderCombo->new( $self, 100, ' L  ', "lightness of $type color",   0, 100,  0);
    $self->{'display'}= App::GUI::Sierpingraph::ColorDisplay->new( $self, 25, 10, $init);
