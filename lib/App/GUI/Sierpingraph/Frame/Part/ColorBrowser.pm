...
sub new {
    ...
    $self->{'red'}   =  App::GUI::Sierpingraph::Widget::SliderCombo->new( $self, 290, ' R  ', "red part of $type color",    0, 255,  $rgb[0]);
    $self->{'green'} =  App::GUI::Sierpingraph::Widget::SliderCombo->new( $self, 290, ' G  ', "green part of $type color",  0, 255,  $rgb[1]);
    $self->{'blue'}  =  App::GUI::Sierpingraph::Widget::SliderCombo->new( $self, 290, ' B  ', "blue part of $type color",   0, 255,  $rgb[2]);
    $self->{'hue'}   =  App::GUI::Sierpingraph::Widget::SliderCombo->new( $self, 290, ' H  ', "hue of $type color",         0, 359,  $hsl[0]);
    $self->{'sat'}   =  App::GUI::Sierpingraph::Widget::SliderCombo->new( $self, 294, ' S   ', "saturation of $type color", 0, 100,  $hsl[1]);
    $self->{'light'} =  App::GUI::Sierpingraph::Widget::SliderCombo->new( $self, 294, ' L   ', "lightness of $type color",  0, 100,  $hsl[2]);
