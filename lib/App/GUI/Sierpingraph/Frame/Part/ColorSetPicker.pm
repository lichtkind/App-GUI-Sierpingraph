...
package App::GUI::Sierpingraph::Frame::Part::ColorSetPicker;
...
sub new {
    ...
    $self->{'display'}[$_] = App::GUI::Sierpingraph::Widget::ColorDisplay->new( $self, 16, 8, $_, $default_color ) for 0 .. $self->{'set_size'}-1;
